...
let lose_prompt word =
  ANSITerminal.print_string [ ANSITerminal.Bold; ANSITerminal.red ]
...
let win_prompt word = 
  ANSITerminal.print_string [ ANSITerminal.Bold; ANSITerminal.green ]
